...
/**
 * Abstract base class for tests involving the {@link NativeImageTestEngine}.
 *
 * @since 5.0
 */
public abstract class AbstractNativeImageTestEngineTests {

	private final NativeImageTestEngine engine = new NativeImageTestEngine();
